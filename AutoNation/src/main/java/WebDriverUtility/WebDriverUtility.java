...
import org.openqa.selenium.support.ui.WebDriverWait;
	...
	public class WebDriverUtility {
		...
		public void tab(WebDriver driver, WebElement element) {
			Actions act = new Actions(driver);
			act.keyDown(element, Keys.TAB).keyUp(Keys.TAB).perform();
		}
		public void enter(WebDriver driver, WebElement element) {
			Actions act = new Actions(driver);
			act.keyDown(element, Keys.ENTER).keyUp(Keys.ENTER).perform();
		}
